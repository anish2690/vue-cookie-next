import { App } from 'vue'
import { CookieConfigOptions, SetCookieOptions, keyName, RemoveCookieOptions } from './@types/index'
...
export const VueCookieNext: IVueCookieNext = {
    ...
    setCookie: function (keyName: keyName, value: string, options?: SetCookieOptions) {
